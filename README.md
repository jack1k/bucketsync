...
A quick react/electron app that can watch a folder and upload new files to a google cloud bucket.
...
![Screenshot of the app in use](https://cdn.usq.re/jack/bucketsync.png)
